...
import { pauseCampaign } from "@/app/dashboard/automations/actions";

vi.mock("next/navigation", () => ({ useRouter: () => ({ push: vi.fn(), refresh: vi.fn() }), useSearchParams: () => new URLSearchParams("view=naves") }));
vi.mock("@/lib/supabase/client", () => ({ createClient: vi.fn() }));
vi.mock("@/app/dashboard/automations/actions", () => ({ launchCampaign: vi.fn(), pauseCampaign: vi.fn(), deleteCampaign: vi.fn() }));
