...
function documentKind(attributeClassNames) {
    if (attributeClassNames.includes("DocumentAttributeSticker"))
        return "sticker";
    if (attributeClassNames.includes("DocumentAttributeAnimated"))
        return "animation";
    if (attributeClassNames.includes("DocumentAttributeVideo"))
        return "video";
    if (attributeClassNames.includes("DocumentAttributeAudio"))
        return "audio";
    return "document";
}
export function planForMessage(input) {
    ...
    if (mediaClassName === "MessageMediaPhoto")
        return { kind: "media", mediaKind: "photo" };
