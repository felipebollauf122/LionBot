  ...
  describe("Bot", () => {
    it("should create a valid Bot object", () => {
      const bot: Bot = {
        ...
        payment_gateway: "sigilopay",
        enabled_gateways: ["sigilopay"],
        evpay_api_key: null,
        evpay_project_id: null,
        zuckpay_client_id: null,
        zuckpay_client_secret: null,
        nowpayments_api_key: null,
        nowpayments_ipn_secret_key: null,
        nowpayments_pay_currency: "usdttrc20",
        collect_email_after_payment: false,
        email_request_message: null,
        ...
        avatar_url: null,
        redirect_display_name: null,
        tracking_page_intro: null,
        black_enabled: false,
        protect_content: true,
        traffic_filter_enabled: false,
        tf_block_spies: true,
        tf_block_datacenter: true,
        tf_block_adlibrary: true,
        tf_block_fb_crawler: false,
        tf_block_tiktok_crawler: false,
        slug_gate_enabled: false,
        slug_hash: null,
        slug_plain: null,
        created_at: "2026-04-01T10:00:00Z",
      };
  ...
  describe("Product", () => {
    ...
    it("should allow inactive products", () => {
      const product: Product = {
        ...
        ghost_name: "Produto Reserva",
        ghost_description: "Descrição alternativa exibida no flow black",
