...
export default async function Page({ searchParams }: { searchParams: Promise<AutomationSearchParams> }) {
  ...
  return (
    <AutomationSectionPage title="Postagens agendadas" description="Prepare a sequência de conteúdo, revise as mensagens e defina quando publicar no canal." context={context}
