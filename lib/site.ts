...
export const SITE_TAGLINE = "Assistentes virtuais no Telegram";
export const SITE_DESCRIPTION =
  "Plataforma de assistentes virtuais no Telegram. Acesse conteúdos e suporte de forma rápida e segura.";
