...
export function isCandidateSkipButton(btn: PersistedButton): boolean {
...
export function normalizeLabelForDedupKey(label: string): string {
...
function parseAmountToCents(numStr: string): number | null {
...
export function parsePriceCentsFromLabel(label: string): number | null {
