...
import { automationSectionsByGroup, type AutomationSearchParams } from "@/lib/automations/navigation";
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_280px]">
        <div>
          ...
          <div className="divide-y divide-(--border-default)">
            {automationSectionsByGroup("features").map((section) => (
        ...
        <aside className="space-y-6 border-t border-(--border-default) pt-6 lg:border-t-0 lg:pt-0">
          ...
          {automationSectionsByGroup("connections").map((section) => (
